...
namespace BattleCommon
{
    ...
    {
        private ICombatHealthComponent _health;
        private ICombatAbilityComponent _ability;
        ...
        {
            base.Attach(owner);
            _health = Owner?.Get<ICombatHealthComponent>();
            _ability = Owner?.Get<ICombatAbilityComponent>();
        }

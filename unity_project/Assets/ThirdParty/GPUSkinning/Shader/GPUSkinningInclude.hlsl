...
{
    int row = (index + 0.5) / _GPUSkinning_TextureSize_NumPixelsPerFrame.x;
    int col = index - row * _GPUSkinning_TextureSize_NumPixelsPerFrame.x;

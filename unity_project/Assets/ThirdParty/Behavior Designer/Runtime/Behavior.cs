...
namespace BehaviorDesigner.Runtime
{
    ...
    public abstract class Behavior : MonoBehaviour, IBehavior
    {
        ...
        public void EnableBehavior(BehaviorManager behaviorManager)
        {
            if (behaviorManager)
            {
                behaviorManager.EnableBehavior(this);
            }
        }

        public void DisableBehavior(BehaviorManager behaviorManager)
        {
            if (behaviorManager)
            {
                behaviorManager.DisableBehavior(this, pauseWhenDisabled);
                isPaused = pauseWhenDisabled;
            }
        }

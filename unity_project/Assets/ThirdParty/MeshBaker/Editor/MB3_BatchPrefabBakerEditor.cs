...
namespace DigitalOpus.MB.MBEditor
{
    ...
    public class MB3_BatchPrefabBakerEditor : UnityEditor.Editor
    {
        ...
        public static void CreateNewBatchPrefabBaker()
        {
            ...
            MB3_TextureBaker[] mbs = (MB3_TextureBaker[])UnityEditor.Editor.FindObjectsOfType(typeof(MB3_TextureBaker));
